package edu.zut.awir.awir9.web.soap;

import edu.zut.awir.awir9.service.UserService;
import edu.zut.awir.awir9.web.soap.gen.GetUserRequest;
import edu.zut.awir.awir9.web.soap.gen.GetUserResponse;
import edu.zut.awir.awir9.web.soap.gen.GetUsersRequest;
import edu.zut.awir.awir9.web.soap.gen.GetUsersResponse;
import edu.zut.awir.awir9.web.soap.gen.User;
...
public class UserEndpoint {
    ...
    public GetUserResponse getUser(@RequestPayload GetUserRequest request) {
        ...
        edu.zut.awir.awir9.model.User user = userService.findById(request.getId());
        if (user != null) {
    ...
    private User toSoapUser(edu.zut.awir.awir9.model.User user) {
